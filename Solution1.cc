...
int main(int argc, char *argv[])
{
    ...
    NodeContainer nodes;
    nodes.Create(4);  // เพิ่มโหนดปกติใหม่ รวมทั้งหมดเป็น 4โหนด
    ...
    for (int i = 0; i < NUMBER_OF_EXTRA_NODES; ++i)
{
 ...
 for (int i = 0; i < NUMBER_OF_EXTRA_NODES; ++i)
    ...
    AnimationInterface anim("solution1-topology.xml");
    ...
    flowMonitor->SerializeToXmlFile("solution-1-bot50.xml", true, true);
